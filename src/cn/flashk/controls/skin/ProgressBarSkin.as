package cn.flashk.controls.skin
{
	...
	public class ProgressBarSkin  extends ActionDrawSkin
	{
		...
		override public function reDraw():void {
			...
			for(var mx:Number = 0;mx<progressBar.compoWidth+d*2;mx+=(a+b))
			{
		...
		public function updateValue():void
		{
			...
			if(progressBar.value >0)
			{
				...
				shapeBar.graphics.lineStyle(1, SkinThemeColor.border,1.0,DefaultStyle.pixelHinting,LineScaleMode.NORMAL,CapsStyle.ROUND,JointStyle.ROUND,3);
				shapeBar.graphics.beginGradientFill(GradientType.LINEAR, colors, alphas, ratios, mat);
